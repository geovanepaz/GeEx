...
return array(
    ...
    "A crc32 hash could not be evaluated for the given file" => "No se ha podido calculaTotalVenda el CRC32 del archivo especificado",
    ...
    "An md5 hash could not be evaluated for the given file" => "No se ha podido calculaTotalVenda el MD5 del archivo especificado",
    "File is not readable or does not exist" => "El archivo no se puede leer o no existe",
